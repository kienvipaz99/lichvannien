...
import {APIVantrinhNam, APIXemhuongnha} from '../../res/callapi/Api';
...
import {vanhanhnam} from '../../res/converts';
export default function NhaHopTuoi({
  navigation,
}: {
  ...
  const callData = async () => {
    setLoading(true);
    const aa = await axios.post(`${APIXemhuongnha}`, {
  ...
  return (
    <View style={{flex: 1}}>
      <CustomHeader title="Xem hướng nhà" back onBackPress={navigation} />
        ...
        <ScrollView
          ...
          <View style={styles.view1}>
            ...
            <View style={styles.view3}>
              ...
              />
              <Image source={images.huongnha} style={styles.img} />
              <Text style={styles.txt1}>Tra cứu tử vi hướng nhà</Text>
            </View>
          </View>
        </ScrollView>
      </View>
