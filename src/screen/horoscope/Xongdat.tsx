...
import {APIGiaiHan, APIXongdat} from '../../res/callapi/Api';
...
import {saogiaihan} from '../../res/converts';
...
export default function Xongdat({
  ...
  const callData = async () => {
    setLoading(true);
    try {
      const aa = await axios.post(`${APIXongdat}`, {
  ...
  return (
    <View style={{flex: 1}}>
      <CustomHeader title="Xem tuổi xông đất" back onBackPress={navigation} />
        ...
        <ScrollView
          ...
          <View style={styles.view1}>
            ...
            <View style={styles.view3}>
              ...
              />
              <Image source={images.xongdat} style={styles.img} />
              <Text style={styles.txt1}>Tra cứu tử vi xem tuổi xông đất</Text>
            </View>
          </View>
        </ScrollView>
      </View>
