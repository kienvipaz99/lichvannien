...
import {APIGiaiHan} from '../../res/callapi/Api';
...
import {saogiaihan, vanhanhnam} from '../../res/converts';

export default function BlackTerm({
  navigation,
}: {
  ...
  const callData = async () => {
    setLoading(true);
    try {
      const aa = await axios.post(`${APIGiaiHan}`, {
  ...
  return (
    <View style={{flex: 1}}>
      <CustomHeader title="Xem sao giải hạn" back onBackPress={navigation} />
        ...
        <ScrollView
          ...
          <View style={styles.view1}>
            ...
            <View style={styles.view3}>
              ...
              />
              <Image source={images.xemsaogiaihan} style={styles.img} />
              <Text style={styles.txt1}>Tra cứu tử vi xem sao giải hạn</Text>
            </View>
          </View>
        </ScrollView>
      </View>
